...
def _get_plotting_args(**kwargs):
    ...
    plotting_args['usi1'] = "mzspec:GNPS:TASK-c95481f0c53d42e78a61bf899e9f9adb-spectra/specs_ms.mgf:scan:1943"
...
def test_get_plotting_args_unspecified_mz_range():
    ...
    plotting_args = views.get_drawing_controls(**_get_plotting_args(), mirror=True)
    assert plotting_args['mz_min'] is None
    plotting_args = views.get_drawing_controls(**_get_plotting_args(), mirror=True)
    assert plotting_args['mz_max'] is None
...
def test_get_plotting_args_invalid_mz_range():
    plotting_args = views.get_drawing_controls(**_get_plotting_args(mz_min=-100))
    assert plotting_args['mz_min'] is None
    plotting_args = views.get_drawing_controls(**_get_plotting_args(mz_max=-100))
    assert plotting_args['mz_max'] is None
    plotting_args = views.get_drawing_controls(**_get_plotting_args(mz_min=-100),
                                               mirror=True)
    assert plotting_args['mz_min'] is None
...
def test_prepare_spectrum_annotate_peaks_specified():
    ...
    spectrum_processed = views.prepare_spectrum(
        spectrum, **views.get_drawing_controls(**_get_plotting_args(
            ...
            annotate_peaks=[477.2525, 654.3575])))
