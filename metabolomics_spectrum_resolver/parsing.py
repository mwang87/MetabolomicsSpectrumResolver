...
usi_metabolomics_pattern = re.compile(
    ...
    # Metabolomics collection identifiers: GNPS, MASSBANK, MS2LDA, MOTIFDB, MTBLS, ST, NORMAN
    r":(MASSIVEKB|GNPS|GNPS2|MASSBANK|MS2LDA|MOTIFDB|TINYMASS|MTBLS\d+|ST\d{6}|NORMAN-[0-9a-fA-F-]+)"
    # msRun identifier
    r":(.*)"
    # index flag
